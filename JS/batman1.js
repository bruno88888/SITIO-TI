...
function resta(){
    ...
    var valor2 = 13;
    var resultado = valor1 - valor2;
    alert("El resultado de la resta de "+valor1+" y "+valor2+" es:"+resultado)
}
...
function multiplicar(){
    ...
    var valor2 = 13;
    var resultado = valor1 * valor2;
    alert("El resultado de la multiplicacion de "+valor1+" y "+valor2+" es:"+resultado)
}
...
function dividir(){
    ...
    var valor2 = 13;
    var resultado = valor1 / valor2;
    alert("El resultado de la division de "+valor1+" y "+valor2+" es:"+resultado)
}
...
function ejercicio7(){
    ...
    dato = window.prompt("Introduce n´´umero ?", "0");
    num = parseInt(dato);

    num = num *2;
    document.write(`El doble del número introducido es: ${num}`);
}
